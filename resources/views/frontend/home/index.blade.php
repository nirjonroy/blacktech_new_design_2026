...
@php
    ...
    $siteName = $SeoSettings->site_name ?? config('app.name', 'Thomas Alexander The Voice');
    ...
    $twitter    = $SeoSettings->twitter_site ?? '@thomasalexanderthevoice';
...
<div class="site-content">
    ...
    <div class="main-banner main-banner-1">
        <div class="owl-carousel banner-carousel" data-items="1" data-nav-arrow="true" data-nav-dots="true" data-autoplay="true" data-space="0" data-sm-items="1" data-md-items="1" data-lg-items="1">
            @foreach($sliders as $slider)
                <div class="item">
                    <div class="banner-inner">
                        <img class="img-fluid banner-bg-one" src="{{ asset($slider->image) }}" alt="">
                        <h1 class="banner-title">{{ $slider->title_two }}</h1>
                        <div class="container">
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6 ms-auto">
                                    <div class="banner-content">
                                        @if ($slider->title_one)
                                            <span class="sub-title">{{ $slider->title_one }}</span>
                                        @endif

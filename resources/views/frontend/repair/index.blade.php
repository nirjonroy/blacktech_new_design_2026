...
<div class="uni-banner" style="background-image: url('https://guruservicegroup.ca/wp-content/uploads/2016/06/Book-An-Appointment-banner.jpg')">
    ...
    <div class="container">
        <div class="row">
            <div class="col-xl-8 col-lg-8">
                <div class="contact-page__left sidebar-card sidebar-download mt-30">
            ...
            <div class="col-xl-4 col-lg-4">
                <div class="contact-page__right">
                    <div class="section-title text-left">
                        ...
                        <img src="{{ asset($service->thumb_image) }}" alt="" width="100px" height="50px" class="img-thumb">
...
function generateTimeButtons(intervalMinutes) {
  ...
  endTime.setHours(22, 0, 0); // Set end time to 10:00 PM

                            ...
                            <input type="hidden" name="product_id" required value="{{ $product->id }}">
                              ...
                              <select name="measure" class="form-control form-select shadow-none" id="">
                                ...
                                <div class="form-group col-12">
                                    ...
                                    <textarea name="meta_description" cols="30" rows="4" class="form-control text-area-4">{{ $product->meta_description }}</textarea>
                                </div>
                                ...
                                <div class="form-group col-12">
                                    ...
                                    @if ($product->meta_image)
                                        <div class="mt-2">
                                            <img src="{{ asset($product->meta_image) }}" alt="meta image" class="img-thumbnail" style="max-height: 150px;">
                                        </div>
                                        <div class="custom-control custom-checkbox mt-2">
                                            <input type="checkbox" class="custom-control-input" id="remove_meta_image_product" name="remove_meta_image" value="1">
                                            <label class="custom-control-label" for="remove_meta_image_product">{{ __('admin.Remove Meta Image') }}</label>
                                        </div>
                                    @endif
                                </div>

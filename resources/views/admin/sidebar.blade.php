      ...
      <ul class="sidebar-menu">
          ...
          <li class="nav-item dropdown {{ Route::is('admin.product-category.*') || Route::is('admin.product-sub-category.*') || Route::is('admin.product-child-category.*') || Route::is('admin.mega-menu-category.*') || Route::is('admin.mega-menu-sub-category') || Route::is('admin.create-mega-menu-sub-category') || Route::is('admin.edit-mega-menu-sub-category') || Route::is('admin.mega-menu-banner') || Route::is('admin.popular-category') || Route::is('admin.featured-category') ? 'active' : '' }}">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="{{ Route::is('admin.product-sub-category.*') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.product-sub-category.index') }}">Projects</a></li>

              <li class="{{ Route::is('admin.product-child-category.*') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.product-child-category.index') }}">Industry</a></li>
          ...
          <li class="nav-item dropdown {{ Route::is('admin.service.*') || Route::is('admin.maintainance-mode') || Route::is('admin.announcement') ||  Route::is('admin.slider.*') || Route::is('admin.home-page') || Route::is('admin.banner-image.index') || Route::is('admin.homepage-one-visibility') || Route::is('admin.cart-bottom-banner') || Route::is('admin.shop-page') || Route::is('admin.seo-setup') || Route::is('admin.menu-visibility') || Route::is('admin.product-detail-page') || Route::is('admin.default-avatar') || Route::is('admin.seller-conditions') || Route::is('admin.subscription-banner') || Route::is('admin.testimonial.*') || Route::is('admin.team-member.*') || Route::is('admin.homepage-section-title') ? 'active' : '' }}">
           <p class="s-divide">{{__('admin.Website Settings')}}</p>
            ...
            <ul class="dropdown-menu">
                ...
                <li class="{{ Route::is('admin.team-member.*') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.team-member.index') }}">Team Members</a></li>
          ...
          <li class="nav-item dropdown {{ Route::is('admin.about-us.*') || Route::is('admin.custom-page.*') || Route::is('admin.terms-and-condition.*') || Route::is('admin.privacy-policy.*') || Route::is('admin.faq.*') || Route::is('admin.error-page.*') || Route::is('admin.contact-us.*') || Route::is('admin.career.*') || Route::is('admin.login-page') ? 'active' : '' }}">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="{{ Route::is('admin.about-us.*') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.about-us.index') }}">{{__('admin.About Us')}}</a></li>
                ...
                <li class="{{ Route::is('admin.career.*') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.career.index') }}">Careers</a></li>
          ...
          <li class="{{ Route::is('admin.contact-message') || Route::is('admin.show-contact-message') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.contact-message') }}">
           ...
           <span>{{__('admin.Contact Message')}}</span></a></li>
             ...
             <li class="{{ Route::is('admin.team-member.*') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.team-member.index') }}">
             <div class="icon">
             <i class="fas fa-user"></i>
             </div>
             <span>Team</span></a></li>
             ...
             <span>{{ __('admin.Redirects') }}</span></a></li>
             ...
             <span style="color:black">Role list</span></a> --}}
            </li>



             {{-- <li class="{{ Route::is('admin.user.permission.index') ? 'active' : '' }}">
                <a class="nav-link" href="{{ route('admin.user.permission.index') }}">
             <div class="icon">
             <i class="fas fa-user"></i>
             </div>
             <span style="color:black">Permission list</span></a>
            </li> --}}

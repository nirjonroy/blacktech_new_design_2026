                        ...
                        <form action="{{ route('admin.blog.update',$blog->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-12">
                                    ...
                                    <textarea name="meta_description" cols="30" rows="4" class="form-control text-area-4">{{ $blog->meta_description }}</textarea>
                                </div>
                                ...
                                <div class="form-group col-12">
                                    ...
                                    @if ($blog->meta_image)
                                        <div class="mt-2">
                                            <img src="{{ asset($blog->meta_image) }}" alt="meta image" class="img-thumbnail" style="max-height: 150px;">
                                        </div>
                                        <div class="custom-control custom-checkbox mt-2">
                                            <input type="checkbox" class="custom-control-input" id="remove_meta_image" name="remove_meta_image" value="1">
                                            <label class="custom-control-label" for="remove_meta_image">{{ __('admin.Remove Meta Image') }}</label>
                                        </div>
                                    @endif
                                </div>
                                ...
                                <div class="form-group col-12">
                                    ...
                                    <textarea name="keywords" cols="30" rows="3" class="form-control text-area-3" placeholder="{{ __('admin.Meta Keywords Placeholder') }}">{{ $blog->keywords }}</textarea>
                                </div>

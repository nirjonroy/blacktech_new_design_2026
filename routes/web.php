...
Route::group(['as'=> 'admin.', 'prefix' => 'admin'],function (){
    ...
    Route::resource('redirect', RedirectController::class)->except(['show']);
    Route::put('redirect-status/{redirect}', [RedirectController::class, 'changeStatus'])->name('redirect-status');
...
Route::group(['as' => 'front.'], function(){
    Route::controller(FrontHomeController::class)->group(function(){
        ...
        Route::get('/project', 'our_project')->name('our-project');
        Route::get('/project/{slug}', 'project')->name('project.show');
        Route::get('/service-details/{slug?}', 'single_service')->name('single.service');
        Route::get('repair/{slug}', 'repair_page')->name('repair');
        Route::get('services', 'all_service')->name('all.service');
        ...
        Route::get('/terms-condition', 'terms_condition')->name('terms_condition');
          ...
          Route::get('/industry/{slug}', 'industry')->name('industry');
          Route::get('/industries', 'industry_all')->name('industry.all');
